...
int blake2xb_init_key( blake2xb_state *S, const size_t outlen, const void *key, size_t keylen)
{
  ...
  /*#$ ZOS CHANGE:Cast required to prevent warning, no static_cast in c, so vanilla cast used.-$#*/
...
int blake2xb_final( blake2xb_state *S, void *out, size_t outlen) {
  ...
  for (i = 0; outlen > 0; ++i) {
      ...
      const uint8_t block_size = (outlen < BLAKE2B_OUTBYTES) ? (uint8_t)outlen : BLAKE2B_OUTBYTES;
      /*#$ ZOS CHANGE:ENDS.-$#*/
